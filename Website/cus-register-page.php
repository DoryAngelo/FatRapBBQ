    ...
    <body>
        ...
        <main>
            <div class="green-block">
                <form action="#" id="form" class="form reg-form" method="post">
                    ...
                    <div class="form-field">
                        ...
                        <div class="form-field-input">
                            <div class="with-desc">
                                ...
                                <small>Password must be 8 characters long, and includes at least 1 uppercase, 1 lowercase, 1 digit, and 1 special character</small>
                            </div>

...
WHERE date_status IN ('fully booked', 'closed')";
                    ...
                    <section class="block">
                        <h3 class="block-heading">Order Summary</h2>
                            <br><p><b>Pickup schedule: <?php echo $_SESSION['DATE_SELECTED']; ?> <?php echo $_SESSION['TIME_SELECTED']; ?> </p><br>
                            </b>
...
if (isset($_POST['submit'])) {
    ...
    echo "<script> window.location.href = 'track-order.php?tracker='+<?php echo $PLACED_ORDER_TRACKER?>;</script>";
}

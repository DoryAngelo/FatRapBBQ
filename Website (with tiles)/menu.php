...
<body class="<?php echo ($PRSN_ROLE === 'Wholesaler') ? 'wholesaler' : ''; ?>">
    ...
    <main>
        ...
        ?>
        <?php if (isset($_SESSION['fail']) == 'Yes') { ?>
            <script>
                Swal.fire({
                    title: "Oops!",
        ...
        <section class="section menu">
            <div class="container">
                <div class="section-heading">
                    <h2>Menu</h2>
                    <form action="cus-home-page.php#calendar-section">
                ...
                <section class="section-body">
                    ...
                    ";
                            ...
                            if ($res_orders) {
                                while ($row_orders = mysqli_fetch_assoc($res_orders)) {
                                    $delivery_hour = $row_orders['DELIVERY_HOUR'];
                    ...
                    ?>
                            <div class="menu-item position">
                                <a class="<?php echo ($total_sum <= 0) ? 'disabledClass' : ''; ?>" href="<?php echo ($total_sum <= 0) ? '#' : SITEURL . 'product-info.php?FOOD_ID=' . $FOOD_ID; ?>">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="inline">
                                            ...
                                            <?php if ($total_sum > 0) : ?>
                                                <p><?php echo $total_sum ?> sticks remaining</p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </a>
